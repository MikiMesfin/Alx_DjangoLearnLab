...
BASE_DIR = Path(__file__).resolve().parent.parent / 'advanced_features_and_security'
...
SECRET_KEY = 'django-insecure-%azuij6#xct^golrx98-o__+xnja2a4a+pr4i@6e0i&73f=2yj'
